/**
 * Shared language definitions for server-side usage.
 * Extracted from app/(navigation)/(code)/util/languages.ts
...
/**
 * All available languages for code syntax highlighting.
 * Uses Shiki language grammars.
 */
 ...
 */
export function getLanguagesSortedByName(): Array<{
  id: string;
  name: string;
}> {
